...
KERNEL_MAKE_FLAGS += -j$(shell prebuilts/tools-tequila/$(HOST_PREBUILT_TAG)/bin/nproc --all)

TOOLS_PATH_OVERRIDE := \
    LD_LIBRARY_PATH=$(BUILD_TOP)/prebuilts/tools-tequila/$(HOST_PREBUILT_TAG)/lib:$$LD_LIBRARY_PATH \
...
ifeq (,$(filter 5.10, $(TARGET_KERNEL_VERSION)))
    ...
    TOOLS_PATH_OVERRIDE += PATH=$(BUILD_TOP)/prebuilts/tools-tequila/$(HOST_PREBUILT_TAG)/bin:$(CLANG_PREBUILTS)/bin:$$PATH
endif
